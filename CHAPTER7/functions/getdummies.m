function [yd,xd,b0,s0]=getdummies(LAMDAPEVIEWS,TAUPEVIEWS,EPSILONPEVIEWS,Y,L,EX,LH,EPSILONH)
N=cols(Y);
...
[yd,xd] = create_dummies(lamdaP,tauP,deltaP,epsilonP,L,muP,sigmaP,N,LH,epsilonH);
% size(yd)
% size(xd)
b0=vec(xd\yd);
