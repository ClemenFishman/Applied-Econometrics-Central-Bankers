function [ ir1,ir2,ir3,ir4,ir5] = get_irfTVAR5TREND(N, HORZ, T, L,LH, Y0,hlast0, beta1, Sbig1,iamat1,beta2,Sbig2,iamat2,tar,tvar,delay,muvol,fvol,qvol,reps,scale,nml,EX)
...
for fi=L+1:HORZ+L
  ...
  %y2
    ...
    e2=ystar5(fi,:)>tar;
    if nml==0
    yhat5(fi,:) = ((xhat5*bb1 + uu1*csigma1)*e1)+...
        ((xhat5*bb2 + uu2*csigma2)*e2);
    else
        yhat5(fi,:) = ((xhat5*bb1 + uu1*csx1)*e1)+...
        ((xhat5*bb2 + uu2*csx2)*e2);
    end  
