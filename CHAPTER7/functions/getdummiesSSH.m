function [yd,xd,b0,s0]=getdummiesSSH(LAMDAPEVIEWS,TAUPEVIEWS,EPSILONPEVIEWS,Y,L,EX,LH,EPSILONH,RW,VOL,TR)
N=cols(Y);
...
[yd,xd] = create_dummiesSSVOL(lamdaP,tauP,deltaP,epsilonP,L,muP,sigmaP,N,LH,epsilonH,sigmaH,TR);
% size(yd)
% size(xd)
b0=vec(xd\yd);
