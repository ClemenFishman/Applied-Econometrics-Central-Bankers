function [hnew, naccept]=svolttCSSNOTRENDSTAR(hnewlag,hleadx,hold,FF,QQ,iQQ,cQQ,varcoef1,varcoef2,iamat,y,x,mumat,Sbig,e2)
...
probnew=probx5SSSTARA(y,xmat,varcoef1,varcoef2,iamat,htrial,Sbig,e2);
probold=probx5SSSTARA(y,xmatold,varcoef1,varcoef2,iamat,hold,Sbig,e2);
