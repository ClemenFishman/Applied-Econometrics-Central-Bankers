function [ hnew,naccept ] = getsvolfactorS( hlast,fbig,Qbig,mubig,beta2,Sbig,...
    y,x,N,L,EX,mu0,iamat,maxh)
...
[hh,nc]=svolttCSSfactorS(hnew(tt-1,:),hleadx,holdx,Fmat,Qmat,iQmat,cQQ,varcoef,iamat,y(tt-1,:),x(tt-1,:),mumat,Sbig,maxh);
...
[hh,nc]=svoltCSSfactorS(hnew(tt-1,:),holdx,Fmat,Qmat,iQmat,cQQ,varcoef,iamat,y(tt-1,:),x(tt-1,:),mumat,Sbig,maxh);
