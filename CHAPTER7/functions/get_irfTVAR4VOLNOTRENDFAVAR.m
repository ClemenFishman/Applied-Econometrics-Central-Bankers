function [ out] = get_irfTVAR4VOLNOTRENDFAVAR(N, HORZ, T, L,LH, Y0,hlast0, beta1, Sbig1,iamat1,beta2,Sbig2,iamat2,tar,tvar,delay,muvol,fvol,qvol,reps,scale,nml,EX,fload,rmat)
