function [yd,xd,b0,s0]=getdummiestrend(LAMDAPEVIEWS,TAUPEVIEWS,EPSILONPEVIEWS,Y,L,EX,LH,EPSILONH,RW)
N=cols(Y);
...
[yd,xd] = create_dummiesT(lamdaP,tauP,deltaP,epsilonP,L,muP,sigmaP,N,LH,epsilonH);
% size(yd)
% size(xd)
b0=vec(xd\yd);
