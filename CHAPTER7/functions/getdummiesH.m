function [yd,xd,b0,s0]=getdummiesH(LAMDAPEVIEWS,TAUPEVIEWS,EPSILONPEVIEWS,Y,L,EX,LH,EPSILONH,hlast)
N=cols(Y);
...
[yd,xd] = create_dummiesH(lamdaP,tauP,deltaP,epsilonP,L,muP,sigmaP,N,LH,epsilonH,sigmaH);
% size(yd)
% size(xd)
b0=vec(xd\yd);
